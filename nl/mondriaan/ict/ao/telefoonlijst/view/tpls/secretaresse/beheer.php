...
include 'includes/menu.php';?>
    <section id='content'>
        <table id="contacten">
            ...
            <thead>
                <tr><td>foto</td><td>naam</td><td>email</td><td>intern</td><td>extern</td><td>afd</td><td colspan="3">acties</td></tr>
            </thead>
            <?php foreach($contacten as $contact):?>
                <tr>
                    <td><figure><img src="img/personen/<?= $contact->getFoto();?>" alt="de foto van <?= $contact->getNaam();?>"></figure></td>
                    ...
                    <td title="bewerk de contact gegevens van dit contact"><a href='?control=secretaresse&action=wijziggebruikers&id=<?= $contact->getId();?>'><img src="img/bewerk.png"></a></td>
